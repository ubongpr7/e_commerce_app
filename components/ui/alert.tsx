...
const alertVariants = cva(
  "relative w-full rounded-lg border border-gray-200 bg-white p-4 text-gray-800 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-gray-700",
  {
    variants: {
      variant: {
        default: "",
