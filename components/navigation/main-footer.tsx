        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>
                <Link href="/vendor/register/start" className="hover:text-primary">
                  Become a Vendor
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="mb-4 text-muted-foreground">Get the latest updates on new products and upcoming sales.</p>
