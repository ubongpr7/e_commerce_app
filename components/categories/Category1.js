...
const Category1 = () => {
  ...
  return (
    <div className="grid grid-cols-4 lg:ml-16 lg:rounded-md lg:mr-16 lg:grid-cols-6 gap-4 mt-2 p-2 text-center lg:gap-0 lg:bg-orange-600 lg:justify-items-center">
      {categories.map((category) => (
        ...
        >
          <div className="w-full flex flex-col items-center">
            ...
            ></div>
            <p className="mt-2 text-center lg:text-gray-900 lg:font-normal lg:text-sm text-xs">{category.title}</p>
          </div>
        </Link>
      ))}
    </div>
