...
// Import the banner schema (defined under 'documents')
import { bannerType } from './documents/banner'; // <-- Add the banner schema here
...
const documents = [
  ...
  productType,
  productVariantType,
  bannerType,  // Add banner schema to documents
];
...
export const schemaTypes = [
  ...
  ...singletons,
  ...blocks,
  ...documents,  // <-- Ensure documents includes the banner schema
];
