"use strict";
var selector_isOverlappingSelection = require("./selector.is-overlapping-selection.cjs"), types = require("@sanity/types"), util_sliceBlocks = require("./util.slice-blocks.cjs"), util_getSelectionStartPoint = require("./util.get-selection-start-point.cjs");
...
const arrowDownOnLonelyBlockObject = {
  ...
  guard: ({
    ...
    if (!firstBlock || !lastBlock)
      return !1;
    const firstBlockStartPoint = util_sliceBlocks.getBlockStartPoint(firstBlock), selectionStartPoint = util_getSelectionStartPoint.getSelectionStartPoint(snapshot.context.selection), lastBlockEndPoint = util_sliceBlocks.getBlockEndPoint(lastBlock), selectionEndPoint = util_getSelectionStartPoint.getSelectionEndPoint(snapshot.context.selection);
  ...
  guard: ({
    ...
    if (!selectionStartBlock || !selectionEndBlock)
      return !1;
    const startBlockStartPoint = util_sliceBlocks.getBlockStartPoint(selectionStartBlock), selectionStartPoint = util_getSelectionStartPoint.getSelectionStartPoint(snapshot.context.selection), endBlockEndPoint = util_sliceBlocks.getBlockEndPoint(selectionEndBlock), selectionEndPoint = util_getSelectionStartPoint.getSelectionEndPoint(snapshot.context.selection);
