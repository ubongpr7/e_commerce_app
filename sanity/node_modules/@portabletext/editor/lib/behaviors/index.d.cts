...
declare type AbstractBehaviorEvent =
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'annotation.toggle'>
      annotation: {
        name: string
        value: {
          [prop: string]: unknown
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'decorator.toggle'>
      decorator: string
      at?: {
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'deserialize'>
      originEvent:
        | PickFromUnion_2<
            NativeBehaviorEvent,
            'type',
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'serialize'>
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'serialization.success'>
      mimeType: MIMEType_2
      data: string
      originEvent: PickFromUnion_2<
        NativeBehaviorEvent,
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'serialization.failure'>
      mimeType: MIMEType_2
      reason: string
      originEvent: PickFromUnion_2<
        NativeBehaviorEvent,
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'list item.add'>
      listItem: string
    }
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'list item.remove'>
      listItem: string
    }
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'list item.toggle'>
      listItem: string
    }
  | {
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'select.next block'>
      select?: 'start' | 'end'
    }
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'split'>
    }
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'style.add'>
      style: string
    }
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'style.remove'>
      style: string
    }
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'style.toggle'>
      style: string
    }
