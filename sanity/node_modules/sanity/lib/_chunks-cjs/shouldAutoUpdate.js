...
var fs = require("node:fs"), path = require("node:path"), resolveFrom = require("resolve-from"), semver = require("semver"), runtime = require("./runtime.js"), readModuleVersion = require("./readModuleVersion.js");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var fs__default = /* @__PURE__ */ _interopDefaultCompat(fs), path__default = /* @__PURE__ */ _interopDefaultCompat(path), resolveFrom__default = /* @__PURE__ */ _interopDefaultCompat(resolveFrom), semver__default = /* @__PURE__ */ _interopDefaultCompat(semver);
...
async function compareStudioDependencyVersions(autoUpdatesImports, workDir, fetchFn = globalThis.fetch) {
  ...
  for (const [pkg, value] of filteredAutoUpdatesImports) {
    ...
    const dependency = dependencies[pkg], manifestPath = resolveFrom__default.default.silent(workDir, path__default.default.join(pkg, "package.json")), installed = semver__default.default.coerce(manifestPath ? (await readModuleVersion.readPackageManifest(manifestPath)).version : dependency);
    if (!installed)
...
function getStudioAutoUpdateImportMap(version) {
...
exports.compareStudioDependencyVersions = compareStudioDependencyVersions;
