"use strict";
var path = require("node:path"), zlib = require("node:zlib"), tar = require("tar-fs"), shouldAutoUpdate = require("./shouldAutoUpdate.js"), buildAction = require("./buildAction2.js"), deploySchemasAction = require("./deploySchemasAction.js"), _internal = require("./_internal.js"), schemaApiClient = require("./schemaApiClient.js"), helpers = require("./helpers.js");
...
`);
  ...
  _internal.SCHEMA_STORE_FEATURE_ENABLED ? await deploySchemasAction.default({
    "extract-manifest": shouldBuild,
    "manifest-dir": `${sourceDir}/static`,
    "schema-required": flags["schema-required"],
    verbose: flags.verbose
  }, context) : shouldBuild && await schemaApiClient.createManifestExtractor({
    ...context,
    safe: !0
  })(`${sourceDir}/static`), spinner = output.spinner("Verifying local content").start();
  try {
